...
// Visual-only for now; favorites are not persisted yet.
const isFav = ref(false)
</script>

<template>
  <li
    class="flex items-start justify-between gap-ds-3 rounded-xl border border-neutral-200 bg-white p-ds-4 transition-shadow duration-150 hover:shadow-lg"
  >
    <a
      :href="pick.url"
      target="_blank"
    ...
    <button
      ...
      :class="isFav ? 'text-accent-700' : 'text-text'"
      :aria-pressed="isFav"
